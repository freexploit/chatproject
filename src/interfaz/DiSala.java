...
public class DiSala extends javax.swing.JDialog {
	...
	public void setIDSala(int IDSala) {
		this.IDSala = IDSala;
                if(IDSala == 0){
                    this.btnAgregarU.setVisible(false);
                    this.lblTitle.setText("Bienvenido al Lobby");
                }
                this.uiSala.run();
    ...
    private void initComponents() {
        ...
        nuevaSala.setBackground(new java.awt.Color(255, 255, 102));
        ...
        enviarArchivo.setBackground(new java.awt.Color(255, 153, 102));
        ...
        btnAgregarU.setBackground(new java.awt.Color(255, 102, 102));
        btnAgregarU.setText("Invitar Usuarios");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(nuevaSala, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
...
private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
    ...
    this.txtMensaje.setText("");
		...
		int id = uiSala.crearSala();
		DiSala newSala = new DiSala(null,false);
		newSala.setIDSala(id);
                newSala.setLogin(login);
                newSala.getLblTitle().setText("SALA: " + id);
		newSala.setVisible(true);
		checkEnviar();
        }//GEN-LAST:event_nuevaSalaActionPerformed

    
    private void checkEnviar(){
        if(this.lstUsuarios.getModel().getSize() > 0){
            this.enviarArchivo.setEnabled(false);
        }else{
            this.enviarArchivo.setEnabled(true);
        }
    }
    
    private void btnAgregarUActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarUActionPerformed
        SelecionarEnviar newAgregar = new SelecionarEnviar(null, true, "Agregar Usuarios", "Agregar Seleccionados");
        newAgregar.getLstUsuarios().setModel(this.uiSala.actualizarListaUsuarios(0));
        newAgregar.setVisible(true);
        
        //Para después de que añada la gente
        checkEnviar();
    ...
    private void enviarArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarArchivoActionPerformed
        SelecionarEnviar newEnviar = new SelecionarEnviar(null, true, "Enviar Archivo", "Enviar a Seleccionados");
        newEnviar.getLstUsuarios().setModel(this.uiSala.actualizarListaUsuarios(IDSala));
        newEnviar.setVisible(true);
